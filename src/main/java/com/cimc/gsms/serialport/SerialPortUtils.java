...
import com.cimc.gsms.protocol.center.ProtocolContralCenter;
import com.cimc.gsms.utils.ArrayUtils;
...
//            throw new CustomException("不存在该串口！");
    ...
    public void readComm() {
        try {      
            ...
            msgDecoder.bytes2PackageData(bytes);*/
            new ProtocolContralCenter().dealWithData(bytes);
        } catch (Exception e) {
